...
## A vous de jouer
Vous allez transformer le code du premier TP du HTML/CSS natif vers Angular en utilisant les composants. Au moins deux composants sont à développer.
Le routage n'est pas demandé.
