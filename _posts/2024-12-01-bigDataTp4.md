...
Commençant tout d'abord par le Streaming Job assuré par Spark Streaming. Créer un projet **spark-processor**.
					...
					<execution>
						...
						<configuration>
							<transformers>
								<transformer
									implementation="org.apache.maven.plugins.shade.resource.ManifestResourceTransformer">
									<mainClass>com.apssouza.kafka.IoTDataProducer</mainClass>
								</transformer>
							</transformers>
						</configuration>
					</execution>
...
serializer.class=com.bigdata.kafka.SensorDataEncoder
kafka.topic=sensor-data
```

Maintenant, mettez tous les projets dans un seul dossier. 
