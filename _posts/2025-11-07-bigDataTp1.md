...
Maintenant, dans le même répertoire, téléchargez le fichier `purchases.txt`, disponible sur [ce lien]((https://drive.google.com/file/d/1miBNQLAYoa-xFWeOOlN0njecajpKL1mS/view?usp=sharing)). Nous allons maintenant le mettre dans le container `namenode` dans un répertoire à nommer `input`. 
