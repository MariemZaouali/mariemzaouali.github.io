...
| Rendez-vous à https://github.com/MariemZaouali/enit_tp1_wordcount Et récupérez le lien pour cloner le projet | <img alt="image" src="https://github.com/user-attachments/assets/8e9ce773-1947-45b0-bd91-491281f5890f" />
|
| Copier le lien et appuyer sur clone. |![image](https://github.com/user-attachments/assets/dd437abd-b9d0-4855-ac2c-1fabdffbf164)|
|Ouvrir le fichier main WordCount et appuyer sur « Current File » puis « Run Configuration ». Choisissez un jdk8 et mettre le chemin vers votre classe main, mettez dans le champs Program Arguments : src/main/resources/input/file.txt src/main/resources/output|   <img alt="image" src="https://github.com/user-attachments/assets/ab3bdb0e-cedd-44f2-8c26-3ffd6cd725fe" />
|
