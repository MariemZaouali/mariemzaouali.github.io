...
|--------------------|----------------------|
| **1.** Ouvrez *IntelliJ IDEA* et cliquez sur **« Get from VCS »**. | <img width="420" alt="image" src="https://github.com/user-attachments/assets/2f46c929-4111-47da-9bb3-b5cc2743d277" />
 |
...
| **5.** Le fichier à analyser se trouve sous **resources/input/file.txt**. <br> Lancez le code sur votre IDE. Ce code est exécuté à ce stade localement sur un fichier léger  **file.txt**  avant de le lancer sur le cluster. Le résultat de l'exécution de l'application sera comme suit →|<img width="420"  alt="image" src="https://github.com/user-attachments/assets/33f58840-8f15-4d07-90a9-9801ed366713" />
|
| **6.** Ouvrez le menu **Maven** (à droite), cliquez sur **Install**.<br> Cela génèrera le fichier `.jar`. | <img width="420"  alt="image" src="https://github.com/user-attachments/assets/cf9a1f99-dd8f-45c2-ab99-b3e85ed7bf50" />|
