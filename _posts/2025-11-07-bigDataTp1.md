...
| **4.** Le fichier à analyser se trouve sous **resources/input/file.txt**.<br> Lancez le code sur votre IDE. Ce code est exécuté à ce stade localement sur un fichier léger (**file.txt**) avant de le lancer sur le cluster.<br> Le résultat de l'exécution de l'application sera comme indique la figure. Un répertoire **output** sera créé dans le répertoire resources, contenant les fichiers résultants de l'exécution du programme **wordcount**. Ouvrez ces fichiers. Vous pouvez changer le contenu du fichier `file.txt` et relancez l'application une autre fois pour voir l'effet du programme `Wordcount`!
 | <img src="https://github.com/user-attachments/assets/33f58840-8f15-4d07-90a9-9801ed366713" width="420" alt="Résultat de l'exécution locale"/> |
| **5.** Ouvrez le menu **Maven** (à droite), cliquez sur **Install**.<br> Cela génèrera le fichier `.jar`. | <img src="https://github.com/user-attachments/assets/cf9a1f99-dd8f-45c2-ab99-b3e85ed7bf50" width="420" alt="Génération du jar avec Maven"/> |
