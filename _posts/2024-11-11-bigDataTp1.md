...
Il est demandé maintenant de passer au mode cluster. Au lieu d’avoir un seul datanode, on veut maintenant deux datanodes. Vous devez donc passer par la configuration du fichier hdfs-site.xml ainsi que la création des espaces pour chaque datanode.
