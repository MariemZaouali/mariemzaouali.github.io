...
export HADOOP_HOME=/opt/hadoop  # Changez le chemin en fonction de l'emplacement de votre installation Hadoop
export PATH=$PATH:$SQOOP_HOME/bin:$HADOOP_HOME/bin
source ~/.bashrc

dans sqoop-env.sh
export SQOOP_HOME=/opt/sqoop-1.4.7.bin__hadoop-2.6.0
export HADOOP_HOME=/opt/hadoop  # Si Hadoop est installé dans ce répertoire
export HADOOP_COMMON_HOME=$HADOOP_HOME
export HADOOP_MAPRED_HOME=$HADOOP_HOME
export HIVE_HOME=/opt/hive  # Si Hive est installé dans ce répertoire
