...
1.	Une fois connecté, nous allons lancer un script pour configurer sqoop.
...
\l
6.	Vous allez accéder à la base « temp_db » avec la commande : \c temp_db
7.	Vous pouvez vérifier s’il y a des tables dans la base : \dt
...
10.	Quittez postgres en tapant \q puis entrée. 
