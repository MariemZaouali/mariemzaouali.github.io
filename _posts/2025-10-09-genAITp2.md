...
<img width="636" height="337" alt="image" src="https://github.com/user-attachments/assets/7c3c113b-368e-4448-9cde-dbed6d32b626" />
...
**Demo**: We'll:
 1.Create a random batch of token IDs (batch_size=2, seq_length=5). This means we want to create two sequences, each containing five IDs. Example: `[23, 54, 2, 88, 19]` and `[12, 99, 5, 45, 7]`.
...
# Part 2 : The Transformer Decoder for Intent Classification
