...
>📓 NOTEZ BIEN
>Nous n’allons pas faire du partitioning sous Hive. Au début, l’idée était d’ajouter une nouvelle colonne à chaque table et de l’alimenter avec une date récente et partitionner les données suivant cette date.
